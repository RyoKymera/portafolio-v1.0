      ...
      <main>
        <Section
          ...
          <div className="w-full min-h-64 sm:min-h-40 flex flex-col justify-around pt-[5%] sm:pt-0 sm:px-10 sm:pb-0 pb-[5%] sm:mt-0 mt-6">
            <h3 className="font-sans text-primary text-2xl md:text-xl sm:lg tracking-wide">Hi, I&aposm</h3>
        ...
        <section id="about">
          <SectionCenter backgroundImage="/img/desk.jpg">
            ...
            <p className="text-xl md:text-lg sm:text-base md:px-20 sm:px-10 font-sans font-light tracking-wide text-justify">
              <br/>
              I&aposm a Frontend Developer with a background in Electromechanical Engineering and a constant passion for technology, visual design, and digital animation. I specialize in building modern, functional, and user-centered interfaces.
              <br/><br/>
              My technical foundation was solidified through the Oracle Next Education (ONE) program by Alura Latam, where I deepened my knowledge in web development, clean coding practices, and logical problem-solving. I&aposm currently transitioning into Fullstack development, expanding my backend skills to deliver more complete and integrated solutions.
              <br/><br/>
              ...
              <br/>
              I&aposve collaborated in agile, multidisciplinary environments such as NoCountry, where I developed real-world projects in team simulations, and I currently lead my own creative agency, Llamative, focused on web development and branding.
              <br/><br/>
              I&aposm known for being proactive, responsible, and highly self-motivated, with a strong sense of adaptability and critical thinking. I thrive in team settings, value clear communication, and am constantly seeking to grow. I enjoy solving problems creatively while maintaining an empathetic and collaborative mindset.
              <br/><br/>
